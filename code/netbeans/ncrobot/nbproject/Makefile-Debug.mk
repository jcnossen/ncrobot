...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-MacOSX/ncrobot

dist/Debug/GNU-MacOSX/ncrobot: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/InputBuffer.o: nbproject/Makefile-${CND_CONF}.mk ../../InputBuffer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/InputBuffer.o ../../InputBuffer.cpp

${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/Model.o: nbproject/Makefile-${CND_CONF}.mk ../../Model.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/Model.o ../../Model.cpp

${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/Vector.o: nbproject/Makefile-${CND_CONF}.mk ../../Vector.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/Vector.o ../../Vector.cpp

${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/main.o: nbproject/Makefile-${CND_CONF}.mk ../../main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/main.o ../../main.cpp

${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/Matrix.o: nbproject/Makefile-${CND_CONF}.mk ../../Matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/Matrix.o ../../Matrix.cpp

${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/CfgParser.o: nbproject/Makefile-${CND_CONF}.mk ../../CfgParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/CfgParser.o ../../CfgParser.cpp

${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/DebugTrace.o: nbproject/Makefile-${CND_CONF}.mk ../../DebugTrace.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/DebugTrace.o ../../DebugTrace.cpp
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-MacOSX/ncrobot
